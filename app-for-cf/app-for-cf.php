 ...
 * @copyright Copyright (C) 2022-2024, Digital Point - app-help@appforcf.com
...
define('APP_FOR_CLOUDFLARE_VERSION', '1.9.3.1');
...
load_plugin_textdomain('app-for-cf', false, dirname(plugin_basename(__FILE__)) . '/languages');
