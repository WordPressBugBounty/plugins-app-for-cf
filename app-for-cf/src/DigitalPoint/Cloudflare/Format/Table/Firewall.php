...
<a class="button-primary" data-click="overlay" href="' . esc_attr(wp_nonce_url(add_query_arg(array('action' => 'rule_registration_challenge'), esc_url(menu_page_url('app-for-cf_firewall', false))))) . '"><span aria-hidden="true"><span class="dashicons dashicons-shield"></span>' . esc_html__('Force registration challenge', 'app-for-cf') . '</span></a>
